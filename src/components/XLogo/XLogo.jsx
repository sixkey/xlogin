...
class XLogo extends Component {
    ...
    generatePoints(code, randomness = 0) {
        var points = [];
    ...
    render() {
        const { code, size = "5em", className } = this.props;

        const points = this.generatePoints(code);
        const onHover = this.generatePoints(code, 10);
                ...
                >
                    ...
                    >
                        <animate
                            attributeName="d"
                            values={
                                this.lineFromPoints(points) +
                                " ; " +
                                this.lineFromPoints(onHover)
                            }
                            dur={duration}
